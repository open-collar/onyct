...
namespace OpenCollar.Onyct
{
    ...
    {
        /// <summary>Initializes a new instance of the <see cref="AlreadyInitializedException" /> class.</summary>
        public AlreadyInitializedException()
        { }

        /// <summary>
        /// Initializes a new instance of the <see cref="AlreadyInitializedException" /> class with a specified error
        /// message.
        /// </summary>
        /// <param name="message">The message that describes the error. </param>
        public AlreadyInitializedException([CanBeNull] string message) : base(message)
        { }
        ...
        /// </param>
        public AlreadyInitializedException([CanBeNull] string message, [CanBeNull] Exception innerException) : base(message, innerException)
        { }

        /// <summary>Initializes a new instance of the <see cref="AlreadyInitializedException" /> class with serialized data.</summary>
        /// <param name="info">
