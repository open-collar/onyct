...
namespace OpenCollar.Onyct
{
    ...
    public abstract class ComparableDisposable<T> : Disposable, IEquatable<T>, IComparable, IComparable<T> where T : ComparableDisposable<T>
    {
        /// <summary>
        ...
        public static bool operator ==(ComparableDisposable<T> left, ComparableDisposable<T> right)
        {
